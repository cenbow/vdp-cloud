...
public class VdpJSONResult {
    ...
    public static VdpJSONResult errorMsg(String msg) {
        return new VdpJSONResult(500, msg, null);
    }
    
    public static VdpJSONResult errorMap(Object data) {
        return new VdpJSONResult(501, "error", data);
    }
    
    public static VdpJSONResult errorTokenMsg(String msg) {
        return new VdpJSONResult(502, msg, null);
    }
    
    public static VdpJSONResult errorException(String msg) {
        return new VdpJSONResult(555, msg, null);
    }

    public VdpJSONResult() {
...
//    }
    ...
    public VdpJSONResult(Integer status, String msg, Object data) {
        this.status = status;
        this.msg = msg;
        this.data = data;
    }
